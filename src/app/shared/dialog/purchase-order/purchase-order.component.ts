...
// original qty
  ...
  constructor(
    ...
    this.DeliveryDateValue =
      ...
      this.DispatchDateValue = this.DeliveryDateField.getFullYear() +
      "-" +
      ("0" + (this.DeliveryDateField.getMonth() + 1)).slice(-2) +
      "-" +
      ("0" + this.DeliveryDateField.getDate()).slice(-2);
    ...
    this.general.PODetail(this.userWorkshopid, this.counternumber).subscribe(
      (coounterdata) => {
        ...
        if (coounterdata.success == true) {
          ...
          this.DispatchDateValue = coounterdata.order.dispatchdate;
      ...
      .subscribe(
        (SaveResult) => {
          ...
          if (SaveResult.success == true) {
            ...
            // console.log('SaveResult[0] ', SaveResult[0])
            // console.log('SaveResult[0]["part_number"] ', SaveResult[0]["part_number"])
            if (this.selectedtype == "spare") {
            ...
            let typestock = SaveResult["data"]
            let data = typestock +'data'
           
            this.stockOgQty[SaveResult[data]["part_number"]] = 0
  ...
  makejobtable(jobdata) {
    ...
    // console.log('this.duplicateJob', this.duplicateJob)
    ...
    var result = this.duplicateJob.reduce((unique, o) => {
      ...
      if (
        ...
        // console.log('o 2', o.part_number, o.quantity)
        // console.log('o 2', parseFloat(o["quantity"]))
        // this.stockOgQty[o.part_number] = parseFloat(o["quantity"])
  ...
  removeJobItem(data, index) {
    ...
    // old way to update qty which wasnt accurate
    // this.updateQuantity(
