...
import { ExpenseComponent } from "src/app/components/expense/expense.component";
...
export class AddExpenseComponent implements OnInit {
  ...
  constructor(private generalService: GeneralService,
    ...
    @Inject(MAT_DIALOG_DATA) public data: any) {    const current = new Date();
  ...
  ngOnInit() {
    if (this.counterOpenOrEdit != "edit") {
      forkJoin(
        this.general.getAddExpenseBillNumber(this.userWorkshopid),
      ...
      .subscribe(
        (coounterdata) => {
          ...
          if (coounterdata.success == true) {
            ...
            this.CreateCustomerForm.controls["suppliername"].setValue(
              this.cusname,
              { onlySelf: true }
            );
            this.CreateCustomerForm.controls["phoneOneNo"].setValue(
              this.cusphone,
              { onlySelf: true }
            );
            ...
            this.CreateCustomerForm.controls["suppliername"].disable();
            this.CreateCustomerForm.controls["phoneOneNo"].disable();
  ...
  selectedResult(event) {
    if (this.allcustomuerdata.length != 0) {
      ...
      this.CreateCustomerForm.controls["suppliername"].setValue(name, {
        onlySelf: true,
      });
      this.showtext = true;
      this.showeditcus = true;
  ...
  addnewcustomer() {
   ...
   // this.CreateCustomerForm.controls["address"].setValue("", { onlySelf: true,});
  ...
  Searchcustomer() {
   ...
   // this.CreateCustomerForm.controls["address"].setValue("", {   onlySelf: true, });
   // this.CreateCustomerForm.controls["gstno"].setValue("", { onlySelf: true });
    this.CreateCustomerForm.controls["suppliername"].enable();
    this.CreateCustomerForm.controls["phoneOneNo"].enable();
  ...
  cancelupdate() {
    if (this.counterOpenOrEdit != "edit") {
      ...
      this.CreateCustomerForm.controls["suppliername"].setValue(this.cusname, {
        onlySelf: true,
      });
      this.CreateCustomerForm.controls["phoneOneNo"].setValue(this.cusphone, {
        onlySelf: true,
      });
     // this.CreateCustomerForm.controls["email"].setValue(this.cusemail, {
     //   onlySelf: true,
  ...
  updatecustomer() {
    this.general
      .UpdateCounterCustomer(
        this.userWorkshopid,
        this.CreateCustomerForm.getRawValue().suppliername,
        this.CreateCustomerForm.getRawValue().phoneOneNo,
  ...
  searchBar(event) {
    this.general
      .getAddExpenseCustomerSearch(this.userWorkshopid, event)
      .subscribe(
        (dashResult) => {
